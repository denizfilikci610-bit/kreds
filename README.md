...
| `js/profile.js` | Egen profil (statistik, bio, rediger-sheet med "Del min aktivitet"-toggle, avatar, slet konto-popup, log ud), venne- OG ikke-ven-profil (bio, vennetal via RPC'er, "Tilføj til din kreds"-chip for ikke-venner, "Se aktivitet"-chip + aktivitets-sheet), bobler |
