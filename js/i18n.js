...
const DA = {
  ...
  "list.friends": "Venner",
  "list.kredse": "Kredse",
  "list.shared_kredse": "Fælles kredse",
  "list.shared_note": "Her vises kun kredse, I er i sammen.",
  "list.member_count": "{n} medlemmer",
  "list.empty_friends": "Ingen venner endnu",
  "list.empty_kredse": "Ingen kredse endnu",
  "list.empty_shared": "I er ikke i nogen kredse sammen endnu",
  "list.search_ph": "Søg",
  "ep.name_ph": "Dit navn",
  "ep.bio": "Din bio",
...
const EN = {
  ...
  "list.kredse": "Circles",
  "list.shared_kredse": "Shared circles",
  "list.shared_note": "Only circles you are both in are shown here.",
  "list.member_count": "{n} members",
  "list.empty_friends": "No friends yet",
  "list.empty_kredse": "No circles yet",
  "list.empty_shared": "You are not in any circles together yet",
