...
const DA = {
  ...
  /* Inviter venner. share_text er den besked modtageren får, så den skal give mening
     alene i en SMS: hvem inviterer, og hvordan finder man dem igen bagefter. */
  "invite.title": "Inviter dine venner",
  "invite.text": "VibeFeed er tomt uden dine folk. Send et link til dem, du gerne vil dele dine øjeblikke med.",
  "invite.send": "Send et link",
  "invite.later": "Ikke nu",
  "invite.profile_btn": "Inviter venner",
  "invite.share_text": "{name} har inviteret dig til VibeFeed. Søg efter @{handle}, når du er kommet ind.",
  "invite.share_plain": "Kom med på VibeFeed.",
  "invite.copied": "Linket er kopieret",
  "invite.row_title": "Inviter en ven",
  "invite.row_sub": "Send et link til dem, der ikke er her endnu",
...
const EN = {
  ...
  "invite.text": "VibeFeed is empty without your people. Send a link to those you want to share your moments with.",
  "invite.send": "Send a link",
  "invite.later": "Not now",
  "invite.profile_btn": "Invite friends",
  "invite.share_text": "{name} invited you to VibeFeed. Search for @{handle} once you are in.",
  "invite.share_plain": "Join me on VibeFeed.",
  "invite.copied": "Link copied",
  "invite.row_title": "Invite a friend",
  "invite.row_sub": "Send a link to those who are not here yet",
